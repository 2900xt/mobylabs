...
server.tool(
  "reef_search_new",
  "Create a new research paper search from an abstract. Returns a search ID that can be used to retrieve results. Costs 1 credit per search.",
  {
...
server.tool(
  "reef_get_results",
  "Retrieve search results for a given search ID. Returns the original search info and a list of similar research papers.",
  {
...
server.tool(
  "reef_search",
  "Create a new search AND immediately retrieve results in one call. This is a convenience tool that combines reef_search_new and reef_get_results. Costs 1 credit.",
  {
    abstract: z.string().describe("The research paper abstract or description to search for similar papers"),
    userId: z.string().optional().describe("Your Reef API user ID. If not provided, uses REEF_USER_ID environment variable"),
  },
